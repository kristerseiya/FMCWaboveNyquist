...
print('          Proposed: {:.4f}m, {:.4f}m/s'.format(x_hat[0], x_hat[1]))

estimator = estimators.LorentzianRegressor(meas_prop, method="BFGS")
x_hat = estimator.estimate(t, signal, second_output)
print('Lorentzian Fitting: {:.4f}m, {:.4f}m/s'.format(x_hat[0], x_hat[1]))
plt.show()