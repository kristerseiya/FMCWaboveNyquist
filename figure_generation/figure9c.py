...
results_filekey = [# ('100525192030_estimates_120924015450_seeds_mf.npz','matchedfilter_optim',{'color':'darkslategrey', 'label':'Matched Filter ($T=10\mu s$, x1)'}),
                   ('100725084519_estimates_100725084519_seeds_tri3000_moresim.npz','wn_snradjust_lattice_faster',{'color':'dodgerblue', 'label':'Proposed ($T=10\mu s$, x1)'}), 
                #    ('100725084519_estimates_100725084519_seeds_tri3000_moresim.npz','lorentz',{'color':'orange', 'label':'Lorentzian Regression ($T=10\mu s$, x1)'}),
                   ('101425040042_estimates_100725084519_seeds_lorentz_redo.npz','lorentz',{'color':'orange', 'label':'Lorentzian Regression ($T=10\mu s$, x1)'}),
                   # ('102125230003_estimates_120924015450_seeds_lorentz_faster.npz','lorentz_faster',{'color':'orange', 'label':'Lorentzian Regression ($T=10\mu s$, x1)'}),
                #    ('121224033817_estimates_120924015450_seeds_tri3000_highsnr.npz','maxpd',{'color':'green', 'label':'Maximum Periodogram ($T=10\mu s$, x1)'}),]
                # ('100725084519_estimates_100725084519_seeds_tri3000_moresim.npz','maxpd',{'color':'green', 'label':'Maximum Periodogram ($T=10\mu s$, x1)'}),
                ('101325192646_estimates_100725084519_seeds_maxpd_redo.npz','maxpd',{'color':'green', 'label':'Maximum Periodogram ($T=10\mu s$, x1)'}),
                # ('100725084519_estimates_100725084519_seeds_tri3000_moresim.npz','matchedfilter_optim',{'color':'grey', 'label':'Matched Filter ($T=10\mu s$, x1)'}),
                ('100825111525_estimates_100725084519_seeds_tri3000mf.npz','matchedfilter_optim',{'color':'grey', 'label':'Matched Filter ($T=10\mu s$, x1)'}),
                # ('100625194305_estimates_100625194305_seeds_tri3000_moresim.npz','matchedfilter_optim',{'color':'grey', 'label':'Matched Filter ($T=10\mu s$, x1)'}), 
                ...
                #    ('100725073440_estimates_100725073440_seeds_tri600_5_moresim.npz','matchedfilter_optim',{'color':'darkgoldenrod', 'label':'Matched Filter ($T=2\mu s$, x5)'}), 
