...
results_filekey = [ ('100725091013_estimates_100725091013_seeds_sin600_moresim.npz','wn_snradjust_lattice_faster',{'color':'blue', 'label':'Proposed ($T=2\mu s$, x1)'}), 
                ('100825111716_estimates_100725091013_seeds_sin600mf.npz','matchedfilter_optim',{'color':'grey', 'label':'Matched Filter ($T=2\mu s$, x1)'}), 
                   ('101325193206_estimates_100725091013_seeds_freqavg_redo.npz','freqavg',{'color':'rosybrown', 'label':'Tsuchida ($T=2\mu s$, x1)'}),
                ]
