...
results_file = '092625211626_estimates_092625211626_seeds_gridresexp.npz'
results_file = '092925053155_estimates_092925053155_seeds_new.npz'
...
print(derr.shape)
print(derr.size)
print(est_success_rate)
print(est_time)
print(est_n_evals)
plt.figure(figsize=(13*1.5, 7*1.5))
plt.subplot(121)
mesh = plt.pcolormesh(est_success_rate, vmin=0, vmax=1, cmap="GnBu")
...
plt.title("Number of Function Evaluations", fontsize=25, **font)
plt.yticks([0.5,1.5,2.5,3.5,4.5,5.5,6.5,7.5,8.5],[3,4,5,6,7,8,9,10,11])
plt.xticks([0.5,1.5,2.5],[2,4,6])
...
# grid_gen = estimators.grid.GridGenerator(meas_prop)
# points = grid_gen.generate_lattice_grid(4, 6)
# points2 = grid_gen.generate_lattice_grid(8, 3)
