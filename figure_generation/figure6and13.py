...
# ax.plot(test_snr, np.poly1d(polyfit)(test_snr))
ax.plot(test_snr, spl(test_snr), label=r'$\mathbb{E}[\epsilon_n^2]$ fitted')
# ax.plot(test_snr, asymptote1, linewidth=2, linestyle='--', color='red')
# ax.plot(test_snr, asymptote2, linewidth=2, linestyle='--', color='purple')
...
# ax.plot(test_snr, np.poly1d(polyfit2)(test_snr))
...
# ax.plot(test_snr, np.poly1d(polyfit2)(test_snr)/np.poly1d(polyfit)(test_snr))
